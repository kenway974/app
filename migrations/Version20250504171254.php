 ...
 */
final class Version20250504171254 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE goal_category (goal_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_B2368CF4667D1AFE (goal_id), INDEX IDX_B2368CF412469DE2 (category_id), PRIMARY KEY(goal_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
